...
_lr_productions = [
  ...
  ('factor -> factor EQ factor','factor',3,'p_factor_binop','my_parser.py',71),
  ('factor -> factor GT factor','factor',3,'p_factor_binop','my_parser.py',72),
  ('factor -> factor LT factor','factor',3,'p_factor_binop','my_parser.py',73),
  ('factor -> factor GE factor','factor',3,'p_factor_binop','my_parser.py',74),
  ('factor -> factor LE factor','factor',3,'p_factor_binop','my_parser.py',75),
  ('factor -> factor NE factor','factor',3,'p_factor_binop','my_parser.py',76),
  ('factor -> factor AND factor','factor',3,'p_factor_logicop','my_parser.py',80),
  ('factor -> factor OR factor','factor',3,'p_factor_logicop','my_parser.py',81),
  ('factor -> factor CONCAT factor','factor',3,'p_factor_concat','my_parser.py',86),
]
