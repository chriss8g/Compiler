...
int local__internal_4;
int local__internal_5;
local__internal_0 = 6;
local__internal_1 = function_block_1(local__internal_0);
local__internal_2 = 5;
local__internal_3 = 10;
local__internal_4 = 20;
local__internal_5 = function_block_3(local__internal_2, local__internal_3, local__internal_4);
return 0;
}
...
int function_block_3(int a, int b, int c){ 
...
int local_block_3_internal_8;
local_block_3_internal_0 = a;
local_block_3_internal_1 = b;
local_block_3_internal_2 = c;
local_block_3_internal_3 = local_block_3_internal_0 + local_block_3_internal_1;
local_block_3_internal_4 = printf("%d\n", local_block_3_internal_3);

local_block_3_internal_5 = local_block_3_internal_1 * local_block_3_internal_2;
local_block_3_internal_6 = printf("%d\n", local_block_3_internal_5);

local_block_3_internal_7 = local_block_3_internal_2 / local_block_3_internal_0;
local_block_3_internal_8 = printf("%d\n", local_block_3_internal_7);

return local_block_3_internal_8;
}